...
//     useTransform(cappedScroll, [0, endPoint], [1.6, 1]),
//     { stiffness: 80, damping: 20 }
//   );

//   const logoX = useSpring(
//     useTransform(cappedScroll, [0, endPoint], ["0vw", "40vw"]),
//     { stiffness: 80, damping: 20 }
//   );
//   const logoY = useSpring(
//     useTransform(cappedScroll, [0, endPoint], ["0vh", "-40vh"]),
//     { stiffness: 80, damping: 20 }
//   );
...
//   return (
//     <>
//       <div ref={sectionRef} className="relative w-full h-[420vh]">
...
export default function HeroScroll() {
  ...
  // بدل ما نراقب scrollYProgress، منراقب logoOpacity نفسه
  useEffect(() => {
    const unsubscribe = logoOpacity.on("change", (opacity) => {
      // لما يصير اللوغو شفاف كلياً، نعرض الـ navbar
