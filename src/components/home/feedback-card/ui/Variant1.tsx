...
export function Variant1() {
  ...
  return (
    ...
    //     className="w-full mb-4 sm:w-2/4 text-center text-4xl sm:text-5xl md:text-7xl text-white font-semibold my-3 sm:my-6 md:my-9"
    //   >
    ...
    //   </div>
    // </div>
    <div className="relative flex flex-col gap-8" ref={ref}>
      {/* النص الخلفي (وراء المحتوى) */}
      <motion.h1
      ...
      {/* النص الأمامي (outline فوق المحتوى) */}
      <motion.h1
        className="absolute top-0 left-1/2 -translate-x-1/2 text-4xl sm:text-5xl md:text-7xl font-semibold text-transparent stroke-text z-20 text-center"
